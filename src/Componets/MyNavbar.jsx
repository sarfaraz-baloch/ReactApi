...
function MyNavbar({search, setSearch}) {
 ...
 <nav className="bg-slate-400  border-slate-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <Link 
      to="/login"
      className="flex items-center space-x-3 rtl:space-x-reverse bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium text-white rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    >
      Login
    </Link>
